    ...
    <div>
      ...
      >
        ...
        >
          <ol>
            <li>
            <span><h3> Create a Metamask Wallet</h3></span>  Create a MetaMask Wallet using either a
              desktop computer or an iOS/Android mobile device. That will allow
              you to buy, sell, send, and receive Pango Inu.
            </li>
            <li>
 <span><h3> Create a Metamask Wallet</h3></span>  Create a MetaMask Wallet using either a
   desktop computer or an iOS/Android mobile device. That will allow
   you to buy, sell, send, and receive Pango Inu.</li>
          </ol>
        </Col>
      </Row>
    </div>
