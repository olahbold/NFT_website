    ...
    <section id="charity">
      <Row className="g-0">
        ...
        <Col className="my-auto" md={6}>
          <h2 className="special-font">PNG</h2>
          <br />
          <p>
            The Pango Inu token is our foundational currency that will allow
            investors to hold millions or even billions of it in their wallet.
          </p>
