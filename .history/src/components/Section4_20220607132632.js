    ...
    <section id="team">
      <Row className="g-0">
        ...
        <Row className="g-0">
          ...
          <Col sm={6} md={3}>
            <Image src={Paingoin} style={imageStyle} thumbnail></Image>
          ...
          <Col sm={6} md={3}>
            ...
            <p className="team-blurb">
              Hopefully you don't lift this code from my Github and not put me
              here. Just link me - keep the pic.. unless someone owns it.. then
              don't
            </p>
          </Col>
        </Row>
