    ...
    <section id="charity">
      <Row className="g-0">
        ...
        <Col className="my-auto" md={6}>
          ...
          <p>
            Use it for whatever you think will make your art fly off the
            shelves. Your cool universe being built around NFT characters? The
            DAO that your neat tokens give your community members access to?
            Whatever works, amigo.
          </p>
        </Col>
      </Row>
    </section>
